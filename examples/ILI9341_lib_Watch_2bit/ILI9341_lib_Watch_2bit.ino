...
const uint16_t cx = SCR_WD/2, cy = 240/2;  // clock center
...
const uint16_t hHandCol2 = RGBto565(100,100,100);
const uint16_t sHandCol1 = RGBto565(250,20,20);
